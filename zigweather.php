...
Description: ZIGWEATHER HAS BEEN RETIRED AND IS NO LONGER FUNCTIONAL
Version: 2.3.6
Author: ZigPress 
...
/*
Copyright (c) 2010-2016 ZigPress
...
if (!class_exists('zigweather')) {
	...
	class zigweather {
		...
		public function __construct() {
			...
			if (version_compare($wp_version, '4.0', '<')) wp_die('ZigWeather requires WordPress 4.0 or newer. Please update your installation.');
			$this->get_params();
		...
		public function admin_page_options() {
			...
			<h2>ZigWeather - Options</h2>
				<p>THIS PLUGIN HAS BEEN RETIRED</p>
			</div>
			<?php
			return;
			?>
